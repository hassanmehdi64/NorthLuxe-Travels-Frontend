...
export const adminNavItems = [
  ...
  { id: "destinations", label: "Destinations", path: "/admin/destinations", icon: MapPin, roles: ["Admin", "Editor"] },
  ...
  { id: "seasons", label: "Seasons", path: "/admin/seasons", icon: Star, roles: ["Admin", "Editor"] },
